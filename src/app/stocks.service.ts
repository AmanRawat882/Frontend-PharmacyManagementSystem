...
export class StocksService {
  ...
  getStocks()
  {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}`});
       return this.httpClient.get<Stocks[]>('http://65.0.129.31:8081/api/medicine-stock/medicine-stock-information',{headers});
  ...
  updateStocks(medicine:string,count:number)
  {
    ...
    const url = `http://65.0.129.31:8081/api/medicine-stock/update-stock/${medicine}/${count}`;
