...
export class StocksService {
  ...
  getStocks()
  {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}`});
       return this.httpClient.get<Stocks[]>('http://52.78.233.217:8081/api/medicine-stock/medicine-stock-information',{headers});
  ...
  updateStocks(medicine:string,count:number)
  {
    ...
    const url = `http://52.78.233.217:8081/api/medicine-stock/update-stock/${medicine}/${count}`;
